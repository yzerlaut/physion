...
class CalendarWindow(Window):
    ...
    def __init__(self, main,
        ...
        self.add_side_widget(QtWidgets.QLabel(' ')) # space

        self.add_side_widget(QtWidgets.QLabel('  *  Select: ')) # space
        ...
        # subject box
        self.subjectBox = QtWidgets.QComboBox(self.main)
        ...
        self.add_side_widget(self.subjectBox)
        ...
        self.cal = QtWidgets.QCalendarWidget(self.main)
        ...
        self.datafileBox = QtWidgets.QComboBox(self.main)
        ...
        self.plotButton = QtWidgets.QPushButton(' visualize', self.main)
        # self.plotButton.setEnabled(False)
        self.plotButton.clicked.connect(self.main.visualization)
        tab.layout.addWidget(self.plotButton,
                             nCalendarRow+1, self.nWidgetCol-2, 1, 2)

        self.fovButton = QtWidgets.QPushButton(' FOV/window', self.main)
        # self.fovButton.setEnabled(False)
        self.fovButton.clicked.connect(self.main.FOV)
        tab.layout.addWidget(self.fovButton,
                             nCalendarRow+2, self.nWidgetCol-2, 1, 2)

        self.metadataButton = QtWidgets.QPushButton('show metadata', self.main)
