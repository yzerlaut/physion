...
(note from Y.Zerlaut)
    ...
    use it with the following statement:

    After neuropil substraction, calcium signals were deconvolved using the 
    deconvolution algorithm from Friedrich et al. (2017) with settings
    from Pachitariu et al. (2017) and a kernel time constant of X.

    -> Friedrich et al., PloS Comp Biol 2017 
        https://doi.org/10.1371/journal.pcbi.1005423
    -> Pachitariu et al., J. Neurosci. 2017, 
