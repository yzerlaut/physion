...
class BOTSpatialMapsWindow(Window):

    name = 'BOT_spatial_maps'
    ...
    def __init__(self, main,
        ...
        self.add_side_widget(QtWidgets.QLabel('     _-* BOT SPATIAL MAPS *-_ '))
        self.add_side_widget(QtWidgets.QLabel(''))
        self.add_side_widget(QtWidgets.QLabel(''))
        ...
        self.add_side_widget(QtWidgets.QLabel('  - region ID:'),
                spec='large-left')
        self.regionBox = QtWidgets.QLineEdit()
        self.regionBox.setText('Region 1')
        self.add_side_widget(self.regionBox, spec='small-right')

        self.add_side_widget(QtWidgets.QLabel('  - spatial grid :'),
                spec='large-left')
        self.gridBox = QtWidgets.QLineEdit()
        self.gridBox.setText('(3,3)')
        self.add_side_widget(self.gridBox, spec='small-right')

        self.add_side_widget(QtWidgets.QLabel('  - N-repeat :'),
                spec='large-left')
        self.repeatBox = QtWidgets.QLineEdit()
        self.repeatBox.setText('4')
        self.add_side_widget(self.repeatBox, spec='small-right')

        self.add_side_widget(QtWidgets.QLabel('  - interstim (s) :'),
                spec='large-left')
        self.interstimBox = QtWidgets.QLineEdit()
        self.interstimBox.setText('4')
        self.add_side_widget(self.interstimBox, spec='small-right')

        self.add_side_widget(QtWidgets.QLabel('  - duration (s) :'),
                spec='large-left')
        self.durationBox = QtWidgets.QLineEdit()
        self.durationBox.setText('2')
        self.add_side_widget(self.durationBox, spec='small-right')

        self.add_side_widget(QtWidgets.QLabel('  - pre stim. (s) :'),
                spec='large-left')
        self.preBox = QtWidgets.QLineEdit()
        self.preBox.setText('4')
        self.add_side_widget(self.preBox, spec='small-right')
        ...
        self.runButton = QtWidgets.QPushButton(" === RUN Analysis === ", self.main)
        self.runButton.clicked.connect(self.run_bot_analysis)
        self.add_side_widget(self.runButton)
