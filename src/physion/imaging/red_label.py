...
class RedChannelLabellingWindow(Window):

    name = 'red_channel_labelling'
    ...
    def __init__(self, main,
        ...
        #------------------- SIDE PANELS FIRST -------------------
        # folder box
        self.add_side_widget(QtWidgets.QLabel('data folder:'))
        ...
        self.expT= QtWidgets.QLineEdit(self.main)
    ...
    def open_RCL(self):
        """ choose the data folder and load it """
    ...
    on_open = open_RCL
    on_save = save_RCL
    on_hitting_space = switch_roi_RCL
    on_process = prev_roi_RCL
    on_toggle = toggle_RCL
    on_next = next_roi_RCL
