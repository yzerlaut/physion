...
class SpikeSortingWindow(Window):

    name = 'spike_sorting'

    # functions of other modules, used as methods
    from physion.assembling.gui import AssemblingWindow as _AssemblingWindow
    choose_DataTable = _AssemblingWindow.choose_DataTable
    from physion.ephys.spike_sorting import run_spike_sorting
    ...
    def __init__(self, main, tab_id=1):
        ...
        # ========================================================
        #------------------- SIDE PANELS FIRST -------------------
        self.add_side_widget(QtWidgets.QLabel(' _-* SPIKE SORTING *-_ '))
    ...
    #     self.add_side_widget(self.loadFolderBtn)
        ...
        self.add_side_widget(self.loadDataTableBtn)

        self.add_side_widget(QtWidgets.QLabel(' '))

        self.add_side_widget(QtWidgets.QLabel(' -- * Presets * --  '))
        for i in range(8):
            self.add_side_widget(QtWidgets.QLabel(10*' -- '))
        ...
        self.add_side_widget(QtWidgets.QLabel(' '))
        self.add_side_widget(QtWidgets.QLabel(' modify your phy presets '))
        ...
        self.add_side_widget(self.phyBtn, 'small-right')
