...
class PupilWindow(Window):
    ...
    def __init__(self, main,
        ...
        # choose pupil shape
        self.pupil_shape = QtWidgets.QComboBox(self.main)
        ...
        self.playButton.setIcon(self.main.style().standardIcon(QtWidgets.QStyle.SP_MediaPlay))
        self.playButton.setIconSize(iconSize)
        self.playButton.setToolTip("Play")
        self.playButton.setCheckable(True)
        self.pauseButton = QtWidgets.QToolButton()
        self.pauseButton.setCheckable(True)
        self.pauseButton.setIcon(self.main.style().standardIcon(QtWidgets.QStyle.SP_MediaPause))
        self.pauseButton.setIconSize(iconSize)
        self.pauseButton.setToolTip("Pause")

        btns = QtWidgets.QButtonGroup(self.main)
    ...
    def save_pupil_data(self):
        ...
        self.extract_ROI(self.pupilData)
    ...
    # ----------------------------------------------------------
    on_open = open_pupil_data            # [O]
    on_refresh = jump_to_frame           # [R]
    on_process = process_pupil           # [P]
    on_fit = fit_pupil                   # [F]
    on_press1 = set_cursor_1_pupil       # [1]
    on_press2 = set_cursor_2_pupil       # [2]
    on_press3 = process_outliers_pupil   # [3]
    on_press4 = interpolate_pupil        # [4]
    on_press5 = find_outliers_pupil      # [5]
