...
class IntrinsicWindow(Window):
    ...
    def __init__(self, main,
        ...
        self.add_side_widget(self.roiBox, spec='small-middle')
        self.roiButton = QtWidgets.QPushButton("reset", self.main)
        self.roiButton.clicked.connect(self.reset_ROI)
        self.add_side_widget(self.roiButton, 'small-right')
        ...
        # Map shift
        self.add_side_widget(QtWidgets.QLabel('shift:'), spec='small-left')
        self.phaseButton = QtWidgets.QDoubleSpinBox(self.main)
        self.phaseButton.setRange(0, 2*3.14)
        self.phaseButton.setSuffix(' (phase in Rd)')
        self.phaseButton.setValue(0.0)
        self.add_side_widget(self.phaseButton, 
                             spec='large-right')
        ...
        # phaseMapFilterSigma
        self.add_side_widget(QtWidgets.QLabel('  - phaseMapFilterSigma:'),
                        spec='large-left')
        ...
        self.add_side_widget(self.phaseMapFilterSigmaBox, spec='small-right')

        # signMapFilterSigma
        self.add_side_widget(QtWidgets.QLabel('  - signMapFilterSigma:'),
                        spec='large-left')
        ...
        self.add_side_widget(self.signMapFilterSigmaBox, spec='small-right')

        # signMapThr
        self.add_side_widget(QtWidgets.QLabel('  - signMapThr:'),
                        spec='large-left')
        ...
        self.add_side_widget(self.signMapThrBox, spec='small-right')

    
        self.add_side_widget(QtWidgets.QLabel('  - splitLocalMinCutStep:'),
                        spec='large-left')
        ...
        self.add_side_widget(self.splitLocalMinCutStepBox, spec='small-right')

        # splitOverlapThr: 
        self.add_side_widget(QtWidgets.QLabel('  - splitOverlapThr:'),
                        spec='large-left')
        ...
        self.add_side_widget(self.splitOverlapThrBox, spec='small-right')

        # mergeOverlapThr: 
        self.add_side_widget(QtWidgets.QLabel('  - mergeOverlapThr:'),
                        spec='large-left')
        ...
        self.add_side_widget(self.mergeOverlapThrBox, spec='small-right')
    
        self.pasButton = QtWidgets.QPushButton(" = Area Segmentation = ", self.main)
        self.pasButton.clicked.connect(self.perform_area_segmentation)
        self.add_side_widget(self.pasButton, 'large-left')
    ...
    def load_intrinsic_data(self):
        ...
        if os.path.isdir(datafolder):
            ...
            # load data
            self.params,\
                (self.t, self.intrinsicData) = intrinsic_analysis.load_raw_data(self.get_datafolder(),
