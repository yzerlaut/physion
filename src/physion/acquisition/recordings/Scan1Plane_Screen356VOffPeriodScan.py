...
2P_trigger_delay = Scan1Plane_Screen342V.2P_trigger_delay
...
def off_scan_periods(t):
    ...
    # interframe space
    array[ ( ((t-2P_trigger_delay)%framePeriod)>(framePeriod-duration-security) ) &\
                 ( ((t-2P_trigger_delay)%framePeriod)<(framePeriod-security) )  ] = 0. # switch to 0
    return 1.0*array
