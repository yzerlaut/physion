...
class FaceMotionWindow(Window):
    ...
    # ----------------------------------------------------------
    on_open = open_facemotion_data
    on_refresh = refresh_facemotion
